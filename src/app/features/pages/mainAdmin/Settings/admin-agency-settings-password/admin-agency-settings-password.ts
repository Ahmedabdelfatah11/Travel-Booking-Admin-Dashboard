...
@Component({
  selector: 'app-admin-agency-settings-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './admin-agency-settings-password.html',
  styleUrl: './admin-agency-settings-password.css'
})
export class AdminAgencySettingsPassword implements OnInit {
