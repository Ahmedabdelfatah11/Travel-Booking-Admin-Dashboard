...
@Component({
  selector: 'app-tour-agency-settings-profile',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './tour-agency-settings-profile.html',
  styleUrl: './tour-agency-settings-profile.css'
})
export class TourAgencySettingsProfile implements OnInit {
