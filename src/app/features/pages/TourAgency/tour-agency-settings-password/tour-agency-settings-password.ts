...
@Component({
  selector: 'app-tour-agency-settings-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './tour-agency-settings-password.html',
  styleUrl: './tour-agency-settings-password.css'
})
export class TourAgencySettingsPassword implements OnInit {
