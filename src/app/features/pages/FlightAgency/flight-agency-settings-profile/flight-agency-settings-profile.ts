...
@Component({
  selector: 'app-flight-agency-settings-profile',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './flight-agency-settings-profile.html',
  styleUrl: './flight-agency-settings-profile.css'
})
export class FlightAgencySettingsProfile implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.http.put(`${this.apiUrl}/UpdateUserProfile`, formData, {
      ...
      next: () => {
        ...
        this.loadUserProfile(); // Re-fetch to update state
      },
      error: (err) => {
