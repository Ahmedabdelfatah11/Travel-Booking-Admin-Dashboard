...
import { FlightDashboardStats } from '../../../../shared/Interfaces/iflight';

// Recent activity interface
interface RecentActivity {
  id: number;
  type: 'booking' | 'flight_created' | 'flight_updated';
  description: string;
  timestamp: Date;
...
@Component({
  selector: 'app-flight-agency-dashboard',
  imports: [CommonModule, RouterLink],
  templateUrl: './flight-agency-dashboard.html',
  styleUrl: './flight-agency-dashboard.css'
})
export class FlightAgencyDashboard implements OnInit {
  // State signals
  ...
  getActivityIcon(type: string): string {
    switch (type) {
      ...
      case 'flight_created': return 'bi-airplane';
      case 'flight_updated': return 'bi-pencil-square';
