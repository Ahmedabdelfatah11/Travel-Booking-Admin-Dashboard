...
@Component({
  selector: 'app-hotel-agency-settings-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './hotel-agency-settings-password.html',
  styleUrl: './hotel-agency-settings-password.css'
})
export class HotelAgencySettingsPassword implements OnInit {
