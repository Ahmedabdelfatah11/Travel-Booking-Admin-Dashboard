...
@Component({
  selector: 'app-hotel-agency-settings-profile',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './hotel-agency-settings-profile.html',
  styleUrl: './hotel-agency-settings-profile.css'
})
export class HotelAgencySettingsProfile implements OnInit {
